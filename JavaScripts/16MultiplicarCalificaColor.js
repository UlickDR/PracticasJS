...
function muestra(sValor, oTbl, oElemento){
    ...
    */
    ...
    var sValorCal="";
                ...
                for (i=1; i<=10; i++){
                    ...
                    if (isNaN(sValorCapturado))
                        ...
                        if (nCapturado == (nTabla*i)){
                            ...
                            sValorCapturado = document.getElementById("txtResultado"+i).style="border: 4px solid #f00; background-color: #f00";
                        }
        ...
        if (sErr == "")
            document.getElementById("lblCalif").innerHTML = "Calificación = " + nCalif;
        else
            alert(sErr);
    }